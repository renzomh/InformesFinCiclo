...
namespace UPC.SSIA2013.WS.ServiceLibrary
{
    ...
    {
        [OperationBehavior]
        public PersonaDC WSObtenerPersona(String personaId)
        {
            PersonaLogic objPersonaBC = new PersonaLogic();
            return PersonaTL.TranslatePersonaLRToPersonaDC(objPersonaBC.obtenerPersona(personaId));
